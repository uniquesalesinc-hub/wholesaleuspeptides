...
- Payment: ACH bank transfer, debit card, and Zelle accepted (debit & Zelle up to $2,500). No credit cards.
- No net terms
- Orders held until payment clears
...
- Balance due on completion of manufacturing prior to shipping

## Trust Pillars (always present on site)
- Third-party tested (HPLC, LAL, ICP-MS)
- Batch-specific COAs

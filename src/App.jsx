    ...
    <div style={{background:C.off,minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:880,margin:"0 auto",padding:"44px 40px 72px"}}>
        {[
          ...
          {t:"Independent Testing — Every Lot",      b:"HPLC purity analysis, sterility testing, endotoxin testing via LAL (Limulus Amebocyte Lysate) assay, and heavy-metal screening via ICP-MS. Performed by a U.S. third-party laboratory on applicable production lots — not averaged, not based on manufacturer-supplied COAs."},
